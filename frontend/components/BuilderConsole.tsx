  ...
  return (
    <section id="builder">
      <div className="mb-4 flex items-end justify-between">
        <h2 className="font-display text-2xl font-extrabold tracking-wider text-white">Builder Console</h2>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="glass p-5">
          <div className="font-display text-lg font-bold tracking-wide text-white">Register Agent</div>
          ...
          <div className="mt-4 space-y-3">
            ...
            <Field label="Attestation method">
              <select className={inputCls} value={attest} onChange={(e) => setAttest(Number(e.target.value))}>
          ...
          <div className="mt-2 min-h-[18px] font-mono text-[11px]">
            ...
            {regDone && (
              <a className="text-neon-lime" href={`${EXPLORER}${regHash}`} target="_blank" rel="noreferrer">
        ...
        <div className="glass p-5">
          ...
          <div className="mt-2 min-h-[18px] font-mono text-[11px]">
            ...
            {anchorDone && (
              <a className="text-neon-lime" href={`${EXPLORER}${anchorHash}`} target="_blank" rel="noreferrer">
